...
# 2. Custom CSS (Preserving Original 3D Buttons & Adding Modern Tweaks)
st.markdown("""
    <style>
    div.stButton > button {
...
# 3. Session State Initialization (Robust App State)
...
if 'members_db' not in st.session_state:
    ...
    # Optionally load background data here
...
# --- PRESERVING ORIGINAL 3D MENU LAYOUT ---
...
if st.session_state.page == "Dashboard":
    ...
    # You can expand Collection logic similar to old code here if needed.
