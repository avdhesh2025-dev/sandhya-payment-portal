...
# 🟢 INITIALIZE SESSION STATES (REMOVED QUERY PARAMS TO PREVENT REDIRECT LOOP)
...
# 🛑 JAVASCRIPT: PREVENT ZOOM & MEMORY-SAFE GPS (Runs Only Once)
st.components.v1.html("""
    ...
    // FIX: Using setTimeout instead of setInterval to prevent Memory Leak / Crash
    setTimeout(fetchGPS, 2000);
    </script>
""", height=0, width=0)
